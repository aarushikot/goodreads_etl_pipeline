...
<img src="https://github.com/aarushikot/goodreads_etl_pipeline/blob/master/docs/images/goodreads.png" align="centre">

## Architecture 
![Pipeline Architecture](https://github.com/aarushikot/goodreads_etl_pipeline/blob/master/docs/images/architecture.png)
...
Detailed instructions on how to set up Airflow using AWS CloudFormation script are provided here - [Airflow using AWS CloudFormation](https://github.com/san089/Data_Engineering_Projects/blob/master/Airflow_Livy_Setup_CloudFormation.md)
...
Finally, copy the dag and plugin folder to EC2 inside airflow home directory. Also, checkout [Airflow Connection](https://github.com/aarushikot/goodreads_etl_pipeline/blob/master/docs/Airflow_Connections.md) for setting up connection to EMR and Redshift from Airflow.
...
![Pipeline DAG](https://github.com/aarushikot/goodreads_etl_pipeline/blob/master/docs/images/goodreads_dag.PNG)

DAG View:
![DAG View](https://github.com/aarushikot/goodreads_etl_pipeline/blob/master/docs/images/DAG.PNG)

DAG Tree View:
![DAG Tree](https://github.com/aarushikot/goodreads_etl_pipeline/blob/master/docs/images/DAG_tree_view.PNG)

DAG Gantt View: 
![DAG Gantt View](https://github.com/aarushikot/goodreads_etl_pipeline/blob/master/docs/images/DAG_Gantt.PNG)
...
![Source Dataset Count](https://github.com/aarushikot/goodreads_etl_pipeline/blob/master/docs/images/DatasetCount.PNG)


DAG Run Results:
![GoodReads DAG Run](https://github.com/aarushikot/goodreads_etl_pipeline/blob/master/docs/images/DAG_tree_view.PNG)

Data Loaded to Warehouse:
![GoodReads Warehouse Count](https://github.com/aarushikot/goodreads_etl_pipeline/blob/master/docs/images/WarehouseCount.PNG)
...
This project is currently maintained by Aarushi Kotwani, a Data Professional with over four years of experience in data engineering and analytics. She specializes in building robust ETL pipelines and translating analytical insights into actionable recommendations.

Connect with Aarushi on [GitHub](https://github.com/aarushikot/) or [LinkedIn](https://www.linkedin.com/in/aarushikotwani/). For inquiries, reach out at [aarushi.kotwani.in@gmail.com](mailto:aarushi.kotwani.in@gmail.com).